...
def main():
    ...
    # content_human_message = "Fetch the UK's GDP over the past 5 years, then draw a line graph of it. Once you code it up, finish."
    ...
    events = graph.stream(
        {
            "messages": [HumanMessage(content=content_human_message)],
        },
